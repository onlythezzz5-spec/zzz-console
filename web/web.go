...
import (
	...
	"github.com/onlythezzz5-spec/zzz-console/web/controller"
...
type Server struct {
	...
	panel  *controller.ZZZController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("zzz-console", store))
	...
	s.panel = controller.NewZZZController(g)
